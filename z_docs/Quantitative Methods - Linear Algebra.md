...
!!! tip "Run this module"
    ```bash
    cd "Quantitative Methods - Linear Algebra"
    python "linear_algebra_tutorial.py"
    ```

    [:octicons-mark-github-16: View source on GitHub](https://github.com/MeridianAlgo/Learn-Quant/tree/main/Quantitative%20Methods%20-%20Linear%20Algebra)

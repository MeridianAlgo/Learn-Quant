...
!!! tip "Run this module"
    ```bash
    cd "Options Chain Simulator"
    python "options_chain_simulator.py"
    ```

    [:octicons-mark-github-16: View source on GitHub](https://github.com/MeridianAlgo/Learn-Quant/tree/main/Options%20Chain%20Simulator)

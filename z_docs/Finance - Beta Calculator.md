...
!!! tip "Run this module"
    ```bash
    cd "Finance - Beta Calculator"
    python "beta_calculator.py"
    ```

    [:octicons-mark-github-16: View source on GitHub](https://github.com/MeridianAlgo/Learn-Quant/tree/main/Finance%20-%20Beta%20Calculator)
...
**Prerequisites**: 
- [Python Basics – Numbers](Python Basics - Numbers.md) (percentages, arithmetic)
- [Quantitative Methods – Statistics](Quantitative Methods - Statistics.md) (covariance, variance, regression)
- [Finance – Correlation Analysis](Finance - Correlation Analysis.md)

**Builds into**:
- [CAPM](CAPM.md) for cost of equity estimation
- [Portfolio Optimizer](Portfolio Optimizer.md) for risk-adjusted allocation
- [Black-Scholes Option Pricing](Black-Scholes Option Pricing.md) for option risk

...
!!! tip "Run this module"
    ```bash
    cd "Strategies - Mean Reversion"
    python "mean_reversion_strategy.py"
    ```

    [:octicons-mark-github-16: View source on GitHub](https://github.com/MeridianAlgo/Learn-Quant/tree/main/Strategies%20-%20Mean%20Reversion)

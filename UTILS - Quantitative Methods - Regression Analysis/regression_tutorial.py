...
def practical_example_market_model() -> None:
    ...
    portfolio_returns = (portfolio_alpha + 
    ...
    print(f"  → Portfolio {'outperforms' if alpha_est > 0 else 'underperforms'} market by {abs(alpha_annual) * 100:.2f}% annually")

...
- For continuous, mean-reverting state instead of discrete regimes, see
  [`Quantitative Methods - Stochastic Processes`](../Quantitative%20Methods%20-%20Stochastic%20Processes/).
- For *detecting* which regime you are in from returns, see
  [`Quantitative Methods - Regime Detection`](../Quantitative%20Methods%20-%20Regime%20Detection/).
- The same machinery powers the prediction step in the
  [`Quantitative Methods - Kalman Filter`](../Quantitative%20Methods%20-%20Kalman%20Filter/).

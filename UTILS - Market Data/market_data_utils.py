...
try:
    ...
    print("Warning: numpy/scipy not found. Some functions may not work optimally. Install with: pip install numpy scipy")
    np = None
    signal = None
...
def calculate_market_microstructure(tick_data: List[Dict[str, Any]]) -> Dict[str, float]:
    """
...
def demo_market_data_utils():
    ...
    news_data = [
        {"title": "Markets rally on positive earnings", "content": "Strong growth reported across sectors"},
        {"title": "Concerns over inflation rise", "content": "Investors worried about price pressures"},
        {"title": "Tech stocks surge higher", "content": "Technology sector shows strong momentum"}
    ]
    keywords = {
